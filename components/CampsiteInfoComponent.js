...
function RenderCampsite(props) {
  ...
  console.log("renderCampsite", props);
  if (campsite) {
    return (
      <Card
...
class CampsiteInfo extends Component {
  ...
  handleComment(campsiteId) {
    ...
    //use this.props since its coming from redux store
      ...
      <ScrollView>
        ...
        >
          <View style={styles.modal}>
            ...
            <View><Button title="Submit" color="#5637DD" onPress={() => {this.handleComment(campsiteId); this.resetForm();}} /></View>
            <View style={{ margin: 10 }}>
              <Button
                color="#808080"
